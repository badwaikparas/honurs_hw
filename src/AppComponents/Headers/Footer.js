function Footer() {
    return (
        <footer class="cd2827bb bt b--black-10 mt4">
            <h2 class="e13b5dae">Footer</h2>
            <div id="footer" class="center mw9 pa3 flex flex-column flex-wrap-m flex-row-ns">
                <div class="flex-auto pa4-ns pa3 w-100 w-10-l">
                    <div class="_802b5507 pt3"><a target="_blank" rel="noopener noreferrer nofollow"
                        href="https://github.com/npm"><svg viewBox="0 0 27.23 27.23" aria-hidden="true">
                    ...
                    <div class="_802b5507 pt3"><a target="_blank" rel="noopener noreferrer nofollow" href="https://github.com"
                        aria-label="GitHub"><svg aria-hidden="true" role="img" class="" viewBox="0 0 16 16" width="50"
                ...
                <div class="flex-auto pa4-ns pa3 w-30-ns w-50-m">
                    ...
                    <ul class="list pl0" aria-labelledby="support">
                        <li class="pv1"><a class="link" href="https://docs.npmjs.com">Help</a></li>
                        ...
                        <li class="pv1"><a class="link" href="/support">Contact npm</a></li>
                    </ul>
                </div>
                <div class="flex-auto pa4-ns pa3 w-30-ns w-50-m">
                    ...
                    <ul class="list pl0" aria-labelledby="company">
                        ...
                        <li class="pv1"><a class="link" href="https://github.blog/tag/npm/">Blog</a></li>
                        <li class="pv1"><a class="link" href="/press">Press</a></li>
                    </ul>
                </div>
                <div class="flex-auto pa4-ns pa3 w-30-ns w-50-m">
                    ...
                    <ul class="list pl0" aria-labelledby="terms">
                        ...
                        <li class="pv1"><a class="link" href="/policies/privacy">Privacy</a></li>
                    </ul>
                </div>
            </div>
        </footer>
